<?php 
  $pageTitle = "Workshop 06: Beyond the AI Hype – The Method of 'Pessimistic Correction' — The ART of Using AI";
  include "header.php"; 
?>
  <style>
...
<body>
  ...
  <section class="workshop-section">
    ...
    <div class="workshop-lecturer">
      <span>Lecturer :</span> <a href="nick-astamidze" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; border-bottom: 1px solid var(--red);">Nikoloz Astamidze</a>
    </div>
