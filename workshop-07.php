<?php 
  $pageTitle = "Workshop 07: AI-Assisted Game Development with Unity — The ART of Using AI";
  include "header.php"; 
?>
  <style>
...
<body>
  ...
  <section class="workshop-section">
    <div class="workshop-eyebrow">Workshop 07</div>
    <span class="workshop-tag">Applied AI</span>
    <h1 class="workshop-title">To Be Announced</h1>
    <div class="workshop-lecturer">
      <span>Lecturer :</span> <a href="nino-latsabidze" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; border-bottom: 1px solid var(--red);">Nino Latsabidze</a>
    </div>
