<?php 
  $pageTitle = "Workshop 05: When AI Gets It Wrong — The ART of Using AI";
  include "header.php"; 
?>
  <style>
...
<body>
  ...
  <section class="workshop-section">
    ...
    <div class="workshop-lecturer">
      <span>Lecturer :</span> <a href="guram-keretchashvili" target="_blank" rel="noopener noreferrer" style="color: inherit; text-decoration: none; border-bottom: 1px solid var(--red);">Guram Keretchashvili</a>
    </div>
